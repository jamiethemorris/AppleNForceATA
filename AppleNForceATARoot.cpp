...
{
	{ PCI_NFORCE1,         PCI_HW_UDMA_100,  0x00,    "nForce 1" },
	{ PCI_NFORCE2,         PCI_HW_UDMA_133,  0x00,    "nForce 2" },
	{ PCI_NFORCE2_PRO,     PCI_HW_UDMA_133,  0x00,    "nForce 2 Pro" },
	{ PCI_NFORCE3,         PCI_HW_UDMA_133,  0x00,    "nForce 3" },
	{ PCI_NFORCE3_PRO ,    PCI_HW_UDMA_133,  0x00,    "nForce 3 Pro" },
	{ PCI_NFORCE_MCP04,    PCI_HW_UDMA_133,  0x00,    "nForce MCP 04" },
	{ PCI_NFORCE_CK804,    PCI_HW_UDMA_133,  0x00,    "nForce CK 804" },
	{ PCI_NFORCE_MCP51,    PCI_HW_UDMA_133,  0x00,    "nForce MCP 51" },
	{ PCI_NFORCE_MCP55,    PCI_HW_UDMA_133,  0x00,    "nForce MCP 55" },
	{ PCI_NFORCE_MCP61,    PCI_HW_UDMA_133,  0x00,    "nForce MCP 61" },
	{ PCI_NFORCE_MCP65,    PCI_HW_UDMA_133,  0x00,    "nForce MCP 65" },
	/* sata part */
	{ PCI_NFORCE2_PRO_S1,  PCI_HW_SATA,      0x00,    "nForce 2 Pro Serial ATA" },
	{ PCI_NFORCE3_PRO_S1,  PCI_HW_SATA,      0x00,    "nForce 3 Pro Serial ATA" },
	{ PCI_NFORCE_MCP04_S1, PCI_HW_SATA,      NV4,     "nForce MCP 04 Serial ATA" },
	{ PCI_NFORCE_MCP04_S2, PCI_HW_SATA,      NV4,     "nForce MCP 04 Serial ATA" },
	{ PCI_NFORCE_CK804_S1, PCI_HW_SATA,      NV4,     "nForce CK 804 Serial ATA" },
	{ PCI_NFORCE_CK804_S2, PCI_HW_SATA,      NV4,     "nForce CK 804 Serial ATA" },
	{ PCI_NFORCE_MCP51_S1, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 51 Serial ATA" },
	{ PCI_NFORCE_MCP51_S2, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 51 Serial ATA" },
	{ PCI_NFORCE_MCP55_S1, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 55 Serial ATA" },
	{ PCI_NFORCE_MCP55_S2, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 55 Serial ATA" },
	{ PCI_NFORCE_MCP61_S1, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 61 Serial ATA" },
	{ PCI_NFORCE_MCP61_S2, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 61 Serial ATA" },
	{ PCI_NFORCE_MCP61_S3, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 61 Serial ATA" },
	{ PCI_NFORCE_MCP65_S5, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 65 Serial ATA" },
	{ PCI_NFORCE_MCP65_S6, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 65 Serial ATA" },
	{ PCI_NFORCE_MCP65_S7, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 65 Serial ATA" },
	{ PCI_NFORCE_MCP65_S8, PCI_HW_SATA,      NV4|NVQ, "nForce MCP 65 Serial ATA" },
...
{
	// return udma 6 or udma 5 
	// (the last one used only by nforce1 mobo)
	// -- medevil
